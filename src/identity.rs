...
pub(crate) const NEEDLE: &str =
    crate::deob!(0x5A, [0x35, 0x2a, 0x3f, 0x34, 0x39, 0x35, 0x3e, 0x3f]);

pub(crate) const H_CLIENT: &str = crate::deob!(
    0x5A,
    [
        0x22, 0x77, 0x35, 0x2a, 0x3f, 0x34, 0x39, 0x35, 0x3e, 0x3f, 0x77, 0x39, 0x36, 0x33, 0x3f,
        0x34, 0x2e
    ]
);
pub(crate) const H_PROJECT: &str = crate::deob!(
    0x5A,
    [
        0x22, 0x77, 0x35, 0x2a, 0x3f, 0x34, 0x39, 0x35, 0x3e, 0x3f, 0x77, 0x2a, 0x28, 0x35, 0x30,
        0x3f, 0x39, 0x2e
    ]
);
pub(crate) const H_REQUEST: &str = crate::deob!(
    0x5A,
    [
        0x22, 0x77, 0x35, 0x2a, 0x3f, 0x34, 0x39, 0x35, 0x3e, 0x3f, 0x77, 0x28, 0x3f, 0x2b, 0x2f,
        0x3f, 0x29, 0x2e
    ]
);
pub(crate) const H_SESSION: &str = crate::deob!(
    0x5A,
    [
        0x22, 0x77, 0x35, 0x2a, 0x3f, 0x34, 0x39, 0x35, 0x3e, 0x3f, 0x77, 0x29, 0x3f, 0x29, 0x29,
        0x33, 0x35, 0x34
    ]
);
...
mod tests {
    ...
    fn a_minted_id_has_the_shape_the_real_client_sends() {
        ...
        assert!(
            rest[12..].bytes().all(|b| b.is_ascii_alphanumeric()),
            "{id}"
        );
    }
    ...
    fn descending_inverts_the_ordered_half() {
        ...
        assert_eq!(ordered_id(0x006f_5fcc_c001, true), 0xff90_a033_3ffe);
    }
